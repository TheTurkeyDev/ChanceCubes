...
public class RewardSelectorPendantGui extends Screen
{
	...
	public void init()
	{
		...
		this.addButton(new Button(i + 57, j + 27, 70, 20, new StringTextComponent(I18n.format("Set Reward")), p_onPress_1_ ->
		{
	...
	public void render(MatrixStack stack, int mouseX, int mouseY, float partialTicks)
	{
		...
		this.rewardField.render(stack, mouseX, mouseY, partialTicks);
	}
}