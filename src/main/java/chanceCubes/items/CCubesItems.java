...
public class CCubesItems
{
	...
	public static DeferredItem<ItemChanceCube> CHANCE_ICOSAHEDRON = ITEMS.register("chance_icosahedron", () -> new ItemChanceCube(CCubesBlocks.CHANCE_ICOSAHEDRON.get()));
	...
	public static final DeferredHolder<CreativeModeTab, CreativeModeTab> CHANCE_TAB = CREATIVE_MODE_TABS.register("tab", () -> CreativeModeTab.builder()
			...
			.displayItems((parameters, output) -> {
				List<ItemStack> stacks = CCubesItems.ITEMS.getEntries().stream()
						.filter(DeferredItem -> DeferredItem.get() != CCubesBlocks.GIANT_CUBE.get().asItem())
