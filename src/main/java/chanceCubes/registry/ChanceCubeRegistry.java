...
public class ChanceCubeRegistry implements IRewardRegistry
{
	...
	public static void loadDefaultRewards()
	{
		...
		INSTANCE.registerReward(new BasicReward(CCubesCore.MODID + ":Sail_Away", 0, new BlockRewardType(new OffsetBlock(0, -1, 0, Blocks.water, false)), new CommandRewardType("/summon Boat %x %y %z"), new MessageRewardType(new MessagePart("Come sail away!"))));
