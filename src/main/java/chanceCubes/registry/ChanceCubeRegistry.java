...
public class ChanceCubeRegistry implements IRewardRegistry
{
	...
	public static void loadDefaultRewards()
	{
		...
		INSTANCE.registerReward(new BasicReward(CCubesCore.MODID + ":Sethbling_Reward", 55, new MessageRewardType(new MessagePart("Welcome back, SethBling here :)").setRange(32)), new ItemRewardType(new ItemPart(new ItemStack(Items.redstone, 32)), new ItemPart(new ItemStack(Items.repeater, 3)), new ItemPart(new ItemStack(Items.comparator, 3)), new ItemPart(new ItemStack(Blocks.redstone_lamp, 3)), new ItemPart(new ItemStack(Blocks.redstone_torch, 3)))));
		...
		INSTANCE.registerReward(new BasicReward(CCubesCore.MODID + ":Poison", -25, new PotionRewardType(new PotionPart(new PotionEffect(Potion.poison.id, 500)))));
		...
		INSTANCE.registerReward(new BasicReward(CCubesCore.MODID + ":Cake", 80, new ItemRewardType(new ItemPart(new ItemStack(Items.cake, 1))), new MessageRewardType(new MessagePart("But is it a lie?").setRange(32))));
		...
		INSTANCE.registerReward(new BasicReward(CCubesCore.MODID + ":Saplings", 35,new MessageRewardType(new MessagePart("Seems you have purchesed the saplings DLC").setRange(32)), new ItemRewardType(new ItemPart(new ItemStack(Blocks.sapling, 4, 0)), new ItemPart(new ItemStack(Blocks.sapling, 4, 1)), new ItemPart(new ItemStack(Blocks.sapling, 4, 2)), new ItemPart(new ItemStack(Blocks.sapling, 4, 3)), new ItemPart(new ItemStack(Blocks.sapling, 4, 4)), new ItemPart(new ItemStack(Blocks.sapling, 4, 5)))));
		...
		INSTANCE.registerReward(new BasicReward(CCubesCore.MODID + ":Fighter", 30, new MessageRewardType(new MessagePart("SPARTAAA!!!").setRange(32)), new ItemRewardType(new ItemPart(new ItemStack(Items.iron_sword)), new ItemPart(new ItemStack(Items.iron_helmet)), new ItemPart(new ItemStack(Items.iron_chestplate)), new ItemPart(new ItemStack(Items.iron_leggings)), new ItemPart(new ItemStack(Items.iron_boots)))));
		...
		INSTANCE.registerReward(new BasicReward(CCubesCore.MODID + ":Explorer", 45, new MessageRewardType(new MessagePart("Lets go on a journey!").setRange(32)), new ItemRewardType(new ItemPart(new ItemStack(Items.compass)), new ItemPart(new ItemStack(Items.clock)), new ItemPart(new ItemStack(Blocks.torch, 64)), new ItemPart(new ItemStack(Items.iron_pickaxe)))));
		...
		INSTANCE.registerReward(new BasicReward(CCubesCore.MODID + ":Horde", -35, new MessageRewardType(new MessagePart("Release the horde!").setRange(32)), new EntityRewardType(RewardsUtil.spawnXEntities(EntityRewardType.getBasicNBTForEntity("Zombie"), 15))));
		INSTANCE.registerReward(new BasicReward(CCubesCore.MODID + ":Insta-Damage", -25, new PotionRewardType(new PotionPart(new PotionEffect(Potion.harm.id, 2, 10)))));
		...
		INSTANCE.registerReward(new BasicReward(CCubesCore.MODID + ":Knockback_Zobmie", -55, new CommandRewardType(new CommandPart("/summon Zombie ~ ~1 ~ {CustomName:\"Leonidas\",IsBaby:1,Equipment:[{id:280,Count:1,tag:{ench:[{id:19,lvl:20}]}},{},{},{},{}],DropChances:[0.0F,0.085F,0.085F,0.085F,0.085F]}"))));
		...
		INSTANCE.registerReward(new BasicReward(CCubesCore.MODID + ":Fireworks", 15, new CommandRewardType(RewardsUtil.executeXCommands("/summon FireworksRocketEntity ~0 ~0 ~0 {LifeTime:5,Motion:[0.00,0.10,0.00],FireworksItem:{id:401,Count:1,tag:{Fireworks:{Explosions:[{Type:1,Flicker:0,Trail:1,Colors:[16711680],FadeColors:[16777215]}]}}}}", 4))));
		...
		INSTANCE.registerReward(new BasicReward(CCubesCore.MODID + ":TNT_Bats", -55, new CommandRewardType(RewardsUtil.executeXCommands("/summon PrimedTnt %x %y %z {Fuse:80,Riding:{id:\"Bat\"}}", 10))));
