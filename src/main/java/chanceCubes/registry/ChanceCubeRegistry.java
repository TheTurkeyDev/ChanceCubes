...
public class ChanceCubeRegistry implements IRewardRegistry
{
	...
	public static void loadDefaultRewards()
	{
		...
		INSTANCE.registerReward(new BasicReward(CCubesCore.MODID + ":Sethbling_Reward", 40, new MessageRewardType(new MessagePart("Welcome back, SethBling here :)")), new ItemRewardType(new ItemStack(Items.redstone, 32), new ItemStack(Items.repeater, 3), new ItemStack(Items.comparator, 3), new ItemStack(Blocks.redstone_lamp, 3), new ItemStack(Blocks.redstone_torch, 3))));
		...
		INSTANCE.registerReward(new BasicReward(CCubesCore.MODID + ":Cake", 45, new ItemRewardType(new ItemStack(Items.cake, 1)), new MessageRewardType(new MessagePart("But is it a lie?"))));
		...
		INSTANCE.registerReward(new BasicReward(CCubesCore.MODID + ":Have_Another", 0, new ItemRewardType(new ItemStack(CCubesBlocks.chanceCube, 3)), new MessageRewardType(new MessagePart("Here, have more!"))));
		...
		INSTANCE.registerReward(new BasicReward(CCubesCore.MODID + ":Farmer", 35, new MessageRewardType(new MessagePart("Time to farm!")), new ItemRewardType(new ItemStack(Items.iron_hoe), new ItemStack(Items.bucket), new ItemStack(Items.wheat_seeds, 16))));
		...
		INSTANCE.registerReward(new BasicReward(CCubesCore.MODID + ":Fighter", 20, new MessageRewardType(new MessagePart("SPARTAAA!!!")), new ItemRewardType(new ItemStack(Items.iron_sword), new ItemStack(Items.iron_helmet), new ItemStack(Items.iron_chestplate), new ItemStack(Items.iron_leggings), new ItemStack(Items.iron_boots))));
		INSTANCE.registerReward(new BasicReward(CCubesCore.MODID + ":pssst", 0, new MessageRewardType(new MessagePart("Pssssst.... Over here!")), new EntityRewardType(EntityRewardType.getBasicNBTForEntity("Creeper"))));
		INSTANCE.registerReward(new BasicReward(CCubesCore.MODID + ":Explorer", 25, new MessageRewardType(new MessagePart("Lets go on a journey!")), new ItemRewardType(new ItemStack(Items.compass), new ItemStack(Items.clock), new ItemStack(Blocks.torch, 64), new ItemStack(Items.iron_pickaxe))));
		...
		INSTANCE.registerReward(new BasicReward(CCubesCore.MODID + ":Want_To_Build_A_Snowman", 50, new MessageRewardType(new MessagePart("Do you want to build a snowman?")), new ItemRewardType(new ItemStack(Blocks.snow, 2), new ItemStack(Blocks.pumpkin))));
