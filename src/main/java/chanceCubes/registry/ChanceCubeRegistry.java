...
public class ChanceCubeRegistry implements IRewardRegistry
{
	...
	public static void loadDefaultRewards()
	{
		...
		INSTANCE.registerReward(new BasicReward(CCubesCore.MODID + ":Fireworks", 0, new CommandRewardType(RewardsUtil.executeXCommands("/summon FireworksRocketEntity ~0 ~0 ~0 {LifeTime:2,Motion:[0.00,0.10,0.00],FireworksItem:{id:401,Count:1,tag:{Fireworks:{Explosions:[{Type:1,Flicker:0,Trail:1,Colors:[16711680],FadeColors:[16777215]}]}}}}", 4))));
		...
		sign.signText[0] = new ChatComponentText("The broken path");
		sign.signText[1] = new ChatComponentText("to succ");
