		...
		Scheduler.scheduleTask(new Task("Table_Flip", 1000, 10)
		{
			...
			public void update()
			{
				switch(stage)
				{
					case 0:
					{
						RewardsUtil.placeBlock(Blocks.OAK_SLAB.getDefaultState().withProperty(BlockSlab.HALF, BlockSlab.EnumBlockHalf.TOP), world, pos);
					...
					case 1:
					{
						...
						RewardsUtil.placeBlock(Blocks.OAK_SLAB.getDefaultState().withProperty(BlockSlab.HALF, BlockSlab.EnumBlockHalf.TOP), world, pos.add(0, 1, 0));
					...
					case 2:
					{
						...
						RewardsUtil.placeBlock(Blocks.OAK_SLAB.getDefaultState().withProperty(BlockSlab.HALF, BlockSlab.EnumBlockHalf.TOP), world, pos.add(0, 2, 1));
					...
					case 3:
					{
						...
						RewardsUtil.placeBlock(Blocks.OAK_SLAB.getDefaultState().withProperty(BlockSlab.HALF, BlockSlab.EnumBlockHalf.BOTTOM), world, pos.add(0, 1, 2));
					...
					case 4:
					{
						...
						RewardsUtil.placeBlock(Blocks.OAK_SLAB.getDefaultState().withProperty(BlockSlab.HALF, BlockSlab.EnumBlockHalf.BOTTOM), world, pos.add(0, 0, 2));
