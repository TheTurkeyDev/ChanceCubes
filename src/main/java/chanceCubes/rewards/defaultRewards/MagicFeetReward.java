...
public class MagicFeetReward implements IChanceCubeReward
{
	...
	{
		player.addChatMessage(new TextComponentString("<Dovah_Jun> You've got magic feet!!!"));
		Scheduler.scheduleTask(new Task("Megic_Feet_Reward_Delay", 300, 2)
		{
			...
			{
				player.addChatMessage(new TextComponentString("<Dovah_Jun> You've used up all the magic in your feet!"));
			}
