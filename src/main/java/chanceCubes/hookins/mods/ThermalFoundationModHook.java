...
public class ThermalFoundationModHook extends BaseModHook
{
	...
	public void loadRewards()
	{
		...
		if(!stack.isEmpty())
		{
			...
			GlobalCCRewardRegistry.INSTANCE.registerReward(new BasicReward(this.modId + ":Grind_Gears", 60, new MessageRewardType(new MessagePart("You really grind my gears ;)")), new ItemRewardType(new ItemPart(stack1))
			{
				@Override
		...
		if(!stack.isEmpty())
		{
			GlobalCCRewardRegistry.INSTANCE.registerReward(new BasicReward(this.modId + ":Crescent_Hammer", 60, new ItemRewardType(new ItemPart(stack))));
		}

		stack = RewardsUtil.getItemStack(super.modId, "meter", 1);
		if(!stack.isEmpty())
		{
			GlobalCCRewardRegistry.INSTANCE.registerReward(new BasicReward(this.modId + ":Multimeter", 60, new ItemRewardType(new ItemPart(stack))));
		}
		...
		{
			ItemStack stack1 = stack;
			GlobalCCRewardRegistry.INSTANCE.registerReward(new BasicReward(this.modId + ":Upgrade", 80, new ItemRewardType(new ItemPart(stack1))
			{
				@Override
				public void trigger(ItemPart s, World world, int x, int y, int z, EntityPlayer player)
				{
		...
		if(!stack.isEmpty())
		{
			GlobalCCRewardRegistry.INSTANCE.registerReward(new BasicReward(this.modId + ":Signalum_Security_Lock", 70, new ItemRewardType(new ItemPart(stack))));
		}
		...
		{
			ItemStack stack1 = stack;
			GlobalCCRewardRegistry.INSTANCE.registerReward(new BasicReward(this.modId + ":Phyto_Gro", 75, new ItemRewardType(new ItemPart(stack1))
			{
				@Override
				public void trigger(ItemPart s, World world, int x, int y, int z, EntityPlayer player)
				{
		...
		{
			ItemStack stack1 = stack;
			GlobalCCRewardRegistry.INSTANCE.registerReward(new BasicReward(this.modId + ":Hardened_Glass", 75, new ItemRewardType(new ItemPart(stack1))
			{
				@Override
				public void trigger(ItemPart s, World world, int x, int y, int z, EntityPlayer player)
				{
		...
		{
			ItemStack stack1 = stack;
			GlobalCCRewardRegistry.INSTANCE.registerReward(new BasicReward(this.modId + ":Hardened_Alloy_Glass", 80, new ItemRewardType(new ItemPart(stack1))
			{
				@Override
				public void trigger(ItemPart s, World world, int x, int y, int z, EntityPlayer player)
				{
