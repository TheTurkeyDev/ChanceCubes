...
public class ExtraUtilsModHook extends BaseModHook
{
	...
	public void loadRewards()
	{
		...
		{
			ChanceCubeRegistry.INSTANCE.registerReward(new BasicReward(this.modId + ":Ender_Lilly", 65, new ItemRewardType(new ItemPart(GameRegistry.findItemStack(super.modId, "plant/ender_lilly", 3)))));
		}
