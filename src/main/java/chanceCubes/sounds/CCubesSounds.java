...
public class CCubesSounds
{
	...
	public static DeferredHolder<SoundEvent, SoundEvent> D20_BREAK = SOUNDS.register("d20_break", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(CCubesCore.MODID, "d20_break")));
	public static DeferredHolder<SoundEvent, SoundEvent> GIANT_CUBE_SPAWN = SOUNDS.register("giant_cube_spawn", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath(CCubesCore.MODID, "giant_cube_spawn")));
